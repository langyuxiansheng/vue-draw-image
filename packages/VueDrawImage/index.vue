...
export default {
    ...
    methods: {
        ...
        setImageBackground (src) {
            ...
            img.src = src;
            img.onload = () => {
                const w = img.width * this.config.scale;
                const h = img.height * this.config.scale;
                this.canvas.width = w;
        ...
        reshow (x, y) {
            ...
            this.layers.forEach(item => {
                ...
                this.ctx.strokeStyle = item.strokeStyle;
                if (x >= (item.x1 - 25 / this.config.scale) && x <= (item.x1 + 25 / this.config.scale) && y <= (item.y2 - 25 / this.config.scale) && y >= (item.y1 + 25 / this.config.scale)) {
                    this.resizeLeft(item);
                } else if (x >= (item.x2 - 25 / this.config.scale) && x <= (item.x2 + 25 / this.config.scale) && y <= (item.y2 - 25 / this.config.scale) && y >= (item.y1 + 25 / this.config.scale)) {
                    this.resizeWidth(item);
                } else if (y >= (item.y1 - 25 / this.config.scale) && y <= (item.y1 + 25 / this.config.scale) && x <= (item.x2 - 25 / this.config.scale) && x >= (item.x1 + 25 / this.config.scale)) {
                    this.resizeTop(item);
                } else if (y >= (item.y2 - 25 / this.config.scale) && y <= (item.y2 + 25 / this.config.scale) && x <= (item.x2 - 25 / this.config.scale) && x >= (item.x1 + 25 / this.config.scale)) {
                    this.resizeHeight(item);
                } else if (x >= (item.x1 - 25 / this.config.scale) && x <= (item.x1 + 25 / this.config.scale) && y <= (item.y1 + 25 / this.config.scale) && y >= (item.y1 - 25 / this.config.scale)) {
                    this.resizeLT(item);
                } else if (x >= (item.x2 - 25 / this.config.scale) && x <= (item.x2 + 25 / this.config.scale) && y <= (item.y2 + 25 / this.config.scale) && y >= (item.y2 - 25 / this.config.scale)) {
                    this.resizeWH(item);
                } else if (x >= (item.x1 - 25 / this.config.scale) && x <= (item.x1 + 25 / this.config.scale) && y <= (item.y2 + 25 / this.config.scale) && y >= (item.y2 - 25 / this.config.scale)) {
                    this.resizeLH(item);
                } else if (x >= (item.x2 - 25 / this.config.scale) && x <= (item.x2 + 25 / this.config.scale) && y <= (item.y1 + 25 / this.config.scale) && y >= (item.y1 - 25 / this.config.scale)) {
                    this.resizeWT(item);
                }
